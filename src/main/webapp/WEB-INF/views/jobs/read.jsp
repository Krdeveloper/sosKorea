      ...
      <div class="row">
        <div class="col-lg-8 mb-4">
          ...
          <form role="form" method="post" name="sentMessage" id="contactForm" novalidate>
        	...
        	<button type="submit" class="btn btn-warning" id="sendMessageButton">Modify</button>
        	<button type="submit" class="btn btn-danger" id="sendMessageButton">Remove</button>
        	<button type="submit" class="btn btn-primary" id="sendMessageButton">List All</button>
       	    </div>
