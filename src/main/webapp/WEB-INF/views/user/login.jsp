  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="/resources/index2.html"><b>sos</b>Korea</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
		...
		<form action="/user/loginPost" method="post">
		  ...
		  <div class="form-group has-feedback">
		    <input type="password" name="secretCode" class="form-control" placeholder="SecretCode If you have"/>
		    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
		  </div>
		  <div class="row">
		    <div class="col-xs-8">    
        ...
        <a href="/user/addMember" class="text-center">Register a new membership</a>
